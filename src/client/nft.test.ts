...
test('create nft extension with 721', async () => {
  ...
  const expectResponse = {
    ...
    image: 'https://ipfs.io/ipfs/QmVe4fv85rd8Zz6wBtAgyrnG6e9LqELWrtG7G86TsRzVJC',
    animation_url: 'https://ipfs.io/ipfs/QmTbtQkgsBV2Yy4Z1E6ySwjzdtjzeUAyV3SakqX4GBqU9S',
  };
...
test('create nft extension with 1155', async () => {
  ...
  const expectResponse = {
    ...
    image: 'https://ipfs.io/ipfs/QmaVCxwVBwvLW9ebBWq5gYgqrX2LB1GjQKQAFBUU84iMvz',
    animation_url: 'https://ipfs.io/ipfs/QmewdmM3XrWH5VA5ZSpjxbMrvYcvtofBQ3bmozKHTU6QZX',
  };
...
test('create nft extension 1155 with fallbacks', async () => {
  ...
  const expectResponse = {
    ...
    image: 'https://gateway.pinata.cloud/ipfs/QmaVCxwVBwvLW9ebBWq5gYgqrX2LB1GjQKQAFBUU84iMvz',
    animation_url: 'https://gateway.pinata.cloud/ipfs/QmewdmM3XrWH5VA5ZSpjxbMrvYcvtofBQ3bmozKHTU6QZX',
  };
  ...
  const client = createPublicClient({
    ...
    nft: nft(client, [new URL('https://gateway.pinata.cloud')]),
  }));
